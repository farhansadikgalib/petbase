...
class NearbyPetsView extends StatefulWidget {
  const NearbyPetsView({Key? key}) : super(key: key);

  @override
  _NearbyPetsViewState createState() => _NearbyPetsViewState();
}

class _NearbyPetsViewState extends State<NearbyPetsView> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        elevation: 0.5,
        title: Text("Nearby Similar"),
        centerTitle: false,
      ),
      body: getPets(),
    );
